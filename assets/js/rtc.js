...
window.addEventListener( 'load', () => {
    ...
    if ( !room ) {
        ...
        document.querySelector('select#audioSource').onchange = changeAudio
        function changeAudio() {
            let audioSource = document.querySelector('select#audioSource').value;
            ...
            .then(function( media ) {
                broadcastNewTracks( media, 'audio' )
